...
void LedDispNum()  //数码管显示数字
{
	...
	select(2);display(0); Delay(500); P7 = 0xff;            //加小数点
	select(1);display(0); Delay(500); P7 = 0xff; //除零
	...
	// 下边一行
	select(12);display(0); Delay(500); P7 = 0xff;
	select(11);display(1); Delay(500); P7 = 0xff;
	select(10);display(3); Delay(500); P7 = 0xff;
